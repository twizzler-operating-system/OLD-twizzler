NETWORK_SRCS=$(addprefix us/bin/network/,network.cpp common.cpp interface.cpp eth.cpp twz.cpp arp.cpp ipv4.cpp udp.cpp tcp.cpp port.cpp encapsulate.cpp char_ring_buffer.cpp tcp_conn.cpp twz_op.cpp client.cpp client_handling_testing.cpp)
