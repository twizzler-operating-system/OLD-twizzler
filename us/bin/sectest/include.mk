...
SECTEST3_SRCS=$(addprefix us/bin/sectest/,main2.c)
SECTEST3_OBJS=$(addprefix $(BUILDDIR)/,$(SECTEST3_SRCS:.c=.o))
...
$(BUILDDIR)/us/sysroot/usr/bin/st2: $(SECTEST3_OBJS) $(SYSROOT_READY) $(SYSLIBS) $(UTILS)
	@echo "[LD]      $@"
	$(TWZCC) $(TWZLDFLAGS) -g -o $@ -MD $< $(SECTEST_LIBS)
...
SYSROOT_FILES+=$(BUILDDIR)/us/sysroot/usr/bin/st $(BUILDDIR)/us/sysroot/usr/bin/st2
#
