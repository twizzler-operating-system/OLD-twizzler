LIBTWZ_SRC=$(addprefix us/libtwz/,object.c fault.c thread.c view.c name.c oa.c event.c mutex.c bstream.c io.c pty.c hier.c kso.c libtwz.c queue.c driver.c seccall.c)
